...
var removeItem = function(list, item) {
      var newList = [];
      // checking for truthy arguements   list == false && item == false
      if (list && item) {
...
var user2 = {
    ...
    password: 'iL435234523',
    username: 'infigdfgsdgfoop'
};

var user3 = {
    name: 'chris chris',
    email: 'tchrsginnis33@gmail.com',
    password: 'iLdsafasgript',
    username: 'igsagasgageLoop'
};
